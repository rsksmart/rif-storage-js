...
export declare type Options = IpfsClient | ClientOptions | BzzConfig;
/**
 ...
 */
export declare type Directory<T> = Record<string, DirectoryEntry<T>>;
/**
 * Object representing single file.
 *
 * @see DirectoryEntry
 */
export declare type DirectoryArrayEntry<T> = DirectoryEntry<T> & {
    path: string;
};
/**
 * Alternative data structure for representing directories. Used mainly together with streaming.
 */
export declare type DirectoryArray<T> = Array<DirectoryArrayEntry<T>>;
export declare type PutInputs = string | Buffer | Readable | Directory<string | Buffer | Readable> | DirectoryArray<Buffer | Readable>;
/**
...
export interface IpfsStorageProvider extends StorageProvider<CidAddress, object, object> {
    readonly ipfs: IpfsClient;
}
export interface SwarmStorageProvider extends StorageProvider<Address, object, object> {
    readonly bzz: Bzz;
}
export declare type AllProviders = IpfsStorageProvider | SwarmStorageProvider | Manager;
